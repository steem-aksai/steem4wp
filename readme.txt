=== Steem for Wordpress ===
Contributors: think-in-universe
Donate link:
...
Installing "Steem for Wordpress" can be done either by searching for "Steem for Wordpress" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
