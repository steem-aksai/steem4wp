 ...
 * Admin API class.
 */
class Steem_for_Wordpress_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'steem-for-wordpress' ) . '" data-uploader_button_text="' . __( 'Use image', 'steem-for-wordpress' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'steem-for-wordpress' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'steem-for-wordpress' ) . '" />' . "\n";
